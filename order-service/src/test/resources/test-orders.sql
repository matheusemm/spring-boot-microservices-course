...
values (1, 'order-123', 'user', 'Siva', 'siva@gmail.com', '11111111', 'Alexanderstraße 123', '1. OG', 'Berlin',
        'Berlin', '12345', 'Germany', 'NEW', '', current_timestamp, current_timestamp),
       (2, 'order-456', 'user', 'Prasad', 'prasad@gmail.com', '22222222', 'Alexanderstraße 456', '2. OG', 'Berlin',
        'Berlin', '45678', 'Germany', 'DELIVERED', '', current_timestamp, current_timestamp);
